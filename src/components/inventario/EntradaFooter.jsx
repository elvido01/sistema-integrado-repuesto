...
const EntradaFooter = ({ totals, entrada, setEntrada }) => {
  return (
    <div className="mt-4 flex justify-between items-center p-4 border-t">
      <div className="flex items-center space-x-2">
        <Checkbox 
          id="imprimir" 
          checked={entrada.imprimir} 
          onCheckedChange={checked => setEntrada({...entrada, imprimir: checked})}
        />
