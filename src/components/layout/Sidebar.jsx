...
const Sidebar = ({ sidebarOpen }) => {
  ...
  console.log("[SidebarDebug] Profile:", profile);
  console.log("[SidebarDebug] Permissions:", permissions);
  ...
  return (
    <motion.div
      ...
      className={`bg-white dark:bg-gray-800 border-r border-gray-200 dark:border-gray-700 flex flex-col fixed top-0 left-0 h-full z-50 transition-transform duration-300 ${sidebarOpen ? 'translate-x-0' : '-translate-x-full md:translate-x-0'
                    ...
                    {sidebarOpen && allowedSubItems.map((subItem) => {
                      ...
                      return (
                        <button
                          ...
                          className={`w-full text-left text-sm py-2 px-4 rounded-md flex items-center ${isSubActive
