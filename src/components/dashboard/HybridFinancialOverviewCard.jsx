...
const HybridFinancialOverviewCard = ({
  ...
  return (
    <div className="bg-white border rounded-xl shadow-sm p-4 flex flex-col h-[340px] hover:shadow-md transition-shadow relative overflow-hidden">
      ...
      <div className="flex items-start justify-between gap-2 mb-4 shrink-0">
        <div className="flex items-center gap-2">
          ...
          <div>
            <p className="text-[10px] font-bold text-slate-500 uppercase tracking-wider">Metas y Proyecciones</p>
            <p className="text-xl font-black text-slate-900">{formatCurrency(meta)}</p>
          </div>
        </div>
      ...
      <div className="flex flex-col flex-1 justify-between">
        ...
        <div className="space-y-2">
           ...
           <div className="flex justify-between text-xs text-slate-500 font-medium">
             ...
             <span>Faltan {formatCurrency(Math.max(meta - ventasActuales, 0))}</span>
           </div>
        </div>
        ...
        <div className="bg-slate-50 rounded-xl p-3 border border-slate-100 flex flex-col justify-center">
           ...
           <div className="grid grid-cols-2 gap-3 pt-3 border-t border-slate-200">
             <div className="flex flex-col">
                ...
                <div className={`flex items-center text-sm font-black ${lograMeta ? 'text-emerald-600' : 'text-rose-500'}`}>
             ...
             <div className="flex flex-col border-l border-slate-200 pl-4 justify-center">
                {totalCompromisosSemana === 0 ? (
                   ...
                   <>
                     ...
                     <span className="text-sm font-black text-amber-600">{formatCurrency(totalCompromisosSemana)}</span>
                     {cajaRestante < 0 && (
