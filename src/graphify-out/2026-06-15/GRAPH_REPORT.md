...
## Summary
- 1524 nodes · 5952 edges · 72 communities (68 shown, 4 thin omitted)
...
- `DropdownMenuShortcut()` --calls--> `cn()`  [EXTRACTED]
  components/ui/dropdown-menu.jsx → lib/utils.js
...
Cohesion: 0.19
Nodes (18): FORMATS_TO_SUPPORT, CLIENTE_GENERICO, MoneyInput, CotizacionMagnaFormModal(), emptyLine(), FORMAS_PAGO, FORMAS_PAGO, TIPOS (+10 more)

### Community 1 - "Business Health and Finance"
Cohesion: 0.05
Nodes (106): CierreCajaPage(), DENOMINACIONES, formatCurrency(), emptyForm, TIPOS_NCF, PROVEEDORES, EntradaDetalles(), EntradaFooter() (+98 more)

### Community 2 - "Client Portfolio and Reports"
Cohesion: 0.12
Nodes (28): ClienteFormModal(), ESTADOS, TIPOS_ECF, VendedorFormModal(), CLAUSULAS_DEFAULT, getDocumentSearchVariants(), normalizeDocument(), money() (+20 more)
...
Cohesion: 0.20
Nodes (13): useCatalogData(), exportToExcel(), nombreById(), orNull(), AlertasGerencialesPage(), ProductsPage(), ChangeProductCodeModal(), EquivalentesPanel() (+5 more)

### Community 8 - "WhatsApp CRM and Messaging"
Cohesion: 0.06
Nodes (38): LayoutContext, LayoutProvider(), useLayout(), channelMeta, cleanPhone(), conversationStatusLabels, conversationStatusOptions, conversationStatusStyles (+30 more)
...
Cohesion: 0.11
Nodes (15): SummaryCard(), CommitmentFormModal(), CommitmentsCard(), formatCurrency(), HybridFinancialOverviewCard(), formatCurrency(), PayCommitmentModal(), formatCurrency() (+7 more)

### Community 11 - "AI Tools and Forecasting"
Cohesion: 0.07
Nodes (23): AiAlertCard(), ALERT_TYPE_TO_PANEL, AREA_ICONS, AiAlertsList(), ALERT_TYPES, AiCeoChat(), AiDecisionCard(), STATUS_LABEL (+15 more)
...
Cohesion: 0.06
Nodes (67): AdminDashboard(), MasterPanel(), MarketingSettingsPanel(), SocialAccountsConnector(), SocialPostsManager(), CreateUserModal(), SuperAdminGuard(), AgenteCambioSuplidor() (+59 more)

### Community 14 - "Company Profile and Budgeting"
Cohesion: 0.19
Nodes (11): SETTING_META, BarcodeScanner(), MultiSearchableSelect(), SearchableSelect(), descargarRespaldoTenant(), TABLAS, supabase, Checkbox (+3 more)

### Community 15 - "User and Permissions Management"
Cohesion: 0.42
Nodes (7): EditUserModal(), Card, CardContent, CardDescription, CardFooter, CardHeader, CardTitle

### Community 16 - "GPS Device and Alerts"
Cohesion: 0.13
Nodes (7): provider, mockGeofences, mockGpsDevices, mockGpsHistory, mockGpsPositions, now, MockGpsProvider
...
Cohesion: 0.26
Nodes (16): PrinterSettings(), agentGetHealth(), agentGetJob(), agentGetJobs(), agentGetPrinterStatus(), agentInvalidateCache(), agentIsAvailable(), AgentJob (+8 more)

### Community 19 - "Sales and Receipt Printing"
Cohesion: 0.36
Nodes (12): printCotizacionQZ(), printFacturaQZ(), printReciboIngresoQZ(), AgentPrinter, findReceiptPrinter(), getPreferredBackend(), listPrinters(), listPrintersForKind() (+4 more)
...
Cohesion: 0.23
Nodes (15): encodeAlphaPrice(), EtiquetasMasivasPage(), MURCIELAGO_KEY, PREFERRED_PRINTERS, encodeAlphaPrice(), MURCIELAGO_KEY, PREFERRED_PRINTERS, PrintLabelModal() (+7 more)

### Community 23 - "Marketing and Content Recommendations"
Cohesion: 0.12
Nodes (10): getDiasRestantes(), normalizeSuscripcion(), normalizeTenant(), AdminEmpresaDetalle(), AdminCuentasBancarias(), EMPTY_CUENTA, AdminPagosReview(), generateId() (+2 more)

### Community 24 - "Subscription Management"
Cohesion: 0.08
Nodes (23): App(), AppContent(), LoginForm(), PlanGate(), SuscripcionAlert(), SuscripcionBlocker(), PanelProvider(), AuthContext (+15 more)
...
Cohesion: 0.25
Nodes (13): GpsAlertsPage(), GpsAlertTable(), GpsDashboardPage(), GpsMap(), GpsMapPage(), GpsPageShell(), tabs, getGpsAlerts() (+5 more)

### Community 28 - "Web USB Printer Integration"
Cohesion: 0.22
Nodes (19): printCotizacionWebUsb(), findBulkOutEndpoint(), getDeviceName(), getSavedDeviceInfo(), LABEL_PRINTER_FILTERS, PRINTER_FILTERS, RECEIPT_PRINTER_FILTERS, reconnectDevice() (+11 more)

### Community 29 - "Branding and Layout Context"
Cohesion: 0.14
Nodes (8): SUGGESTED_PROMPTS, anon, url, TABS, TABS, PRIO_BADGE, ESTADO_LABELS, Textarea

### Community 30 - "GPS Device Management"
Cohesion: 0.15
Nodes (11): GpsDeviceCard(), GpsDeviceForm(), GpsFinancialRiskTable(), bounds, colors, GpsStatusBadge(), labels, styles (+3 more)
...
Cohesion: 0.22
Nodes (11): importPrivateKey(), qzEnsureConnection(), qzFindBestPrinter(), qzFindReceiptPrinter(), qzIsAvailable(), qzListAllPrinters(), qzPrintRawEpl(), qzPrintRawEscPos() (+3 more)

### Community 33 - "App Context and Authentication"
Cohesion: 0.23
Nodes (10): FacturacionContext, FacturacionProvider(), useFacturacion(), useVentas(), findAlmacenPrincipal(), printFacturaWebUsb(), VentasPage(), SugerenciasEquivalentesModal() (+2 more)

### Community 34 - "Theme and Notification Contexts"
Cohesion: 0.12
Nodes (15): RouteGuard(), Logo(), MotoFlowLogo(), ThemeContext, ThemeProvider(), useTheme(), useWhatsAppNotifications(), useNotifications() (+7 more)
...
Cohesion: 0.16
Nodes (11): AiPriorityBadge(), STYLES, AiReportsTimeline(), AiReportViewer(), TIPO_ALERTA_ICON, InsightsBanner(), PRIORIDAD_STYLE, TIPO_ALERTA_LABEL (+3 more)

### Community 40 - "GPS Device Details and Map"
Cohesion: 0.53
Nodes (4): GpsDeviceDetailPage(), getGpsDeviceById(), getGpsPositions(), GpsTimeline()

### Community 41 - "Canva and Design Editor"
Cohesion: 0.22
Nodes (10): useDebounce(), sendNotaToSuplidorVirtual(), ContextMenuContent, ContextMenuItem, ContextMenuLabel, ContextMenuSeparator, ContextMenuSubContent, ContextMenuSubTrigger (+2 more)
...
Cohesion: 0.50
Nodes (4): GpsFinancingPage(), getFinancialRiskRows(), getGpsDevices(), latestByDevice()
...
Cohesion: 0.40
Nodes (5): useSolicitudes(), SolicitudesPage(), SolicitudesTable(), emptyLine(), SolicitudForm()
...
- **Should `Business Health and Finance` be split into smaller, more focused modules?**
  _Cohesion score 0.05166786083910517 - nodes in this community are weakly interconnected._
