      ...
      if (activeTid) {
        ...
        if (empresaError && String(empresaError.message || '').match(/(feat_suplidores_locales|incluir_existencias_cero_default|feat_cliente_dealer|feat_financiera|formato_comprobante_pago|formato_cierre_caja|formato_compra|financiamiento_tipo|financiera_tenant_id|margen_minimo_pct|tipo_negocio|solo_consulta|empresa_vieja_tenant_id|cuenta_bancaria_default_id|firma_url|feat_origen_venta)/)) {
          ...
          empresaData = fallback.data
            ? { ...fallback.data, feat_suplidores_locales: false, incluir_existencias_cero_default: true, feat_cliente_dealer: false, feat_financiera: false, formato_comprobante_pago: 'pdf', formato_cierre_caja: 'pos_80mm', formato_compra: 'pos_4inch', financiamiento_tipo: 'propio', financiera_tenant_id: null, margen_minimo_pct: 0, tipo_negocio: 'repuestos', solo_consulta: false, empresa_vieja_tenant_id: null, cuenta_bancaria_default_id: null, firma_url: null, feat_origen_venta: false }
            : null;
