      ...
      if (profileData?.tenant_id) {
        ...
        if (empresaError && String(empresaError.message || '').match(/(feat_suplidores_locales|incluir_existencias_cero_default|feat_cliente_dealer|feat_financiera|formato_comprobante_pago|financiamiento_tipo|financiera_tenant_id)/)) {
          ...
          empresaData = fallback.data
            ? { ...fallback.data, feat_suplidores_locales: false, incluir_existencias_cero_default: true, feat_cliente_dealer: false, feat_financiera: false, formato_comprobante_pago: 'pdf', financiamiento_tipo: 'propio', financiera_tenant_id: null }
            : null;
