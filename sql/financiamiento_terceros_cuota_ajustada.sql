-- =====================================================================
-- Financiamiento por Terceros: que la CUOTA AJUSTADA viaje al prestamo
-- ---------------------------------------------------------------------
-- En la Solicitud de Compra el operador puede redondear la cuota (campo
-- "Cuota Ajustada"). Esta migracion:
--   1. Guarda esa cuota en solicitudes_compras.cuota_ajustada.
--   2. procesar_financiamiento_terceros la aplica al generar las cuotas del
--      prestamo en la financiera: la cuota pasa a ser la ajustada, el capital
--      se mantiene (capital base por cuota) y el interes = cuota - capital
--      (igual que crear_prestamo con p_cuota_ajustada).
-- Re-ejecutable.
-- =====================================================================
...
SELECT 'procesar_financiamiento_terceros con cuota ajustada listo' AS status;
