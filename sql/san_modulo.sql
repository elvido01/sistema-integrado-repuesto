...
-- ------------------------------------------------------------
-- san_eliminar y san_editar: CANÓNICOS en sql/san_editar_eliminar.sql
-- (eliminar cancelados con o sin pagos; editar regenera el plan y
-- re-aplica lo ahorrado). Correr ese archivo DESPUÉS de este.
-- ------------------------------------------------------------
