...
REVOKE EXECUTE ON FUNCTION public.omni_mirror_heartbeat(boolean,int,int) FROM PUBLIC, anon;
GRANT  EXECUTE ON FUNCTION public.omni_mirror_heartbeat(boolean,int,int) TO authenticated, service_role;
