...
function cuotasDe(h, prestamoId) {
  ...
  // Número REAL de la cuota en el sistema viejo (campo cuota "143/365").
  // Antes se renumeraba 1..N sobre las PENDIENTES y la última salía 217/365
  // en vez de 365/365. Hay unique (tenant, prestamo, numero_cuota): las
  // filas sin número (INT) o duplicadas toman el menor número libre.
