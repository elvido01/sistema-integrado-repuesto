...
`)},Fs=(e,t,i,r)=>{let a=k.size(i),s=new Array(e.length),n=new Array(e.length),o=0,u=[],l=[],d=[{type:12,data:a}];for(let m=0;m<e.length;++m)o+=e[m].dims[t],s[m]=o,l.push(e[m].dims.length),n[m]=S(`input${m}`,r,l[m]),u.push("rank"),d.push({type:12,data:s[m]});for(let m=0;m<e.length;++m)d.push(...D(e[m].dims));d.push(...D(i));let p=B("output",r,i.length),h=p.indicesGet("indices",t),c=Array.from(Array(s.length).keys()).map(m=>`uniforms.sizeInConcatAxis${m}`).join(","),f=m=>`
  ...
  ${m.mainStart()}
    ...
    ${Hs(n,p)}
  }`;return{name:"Concat",shaderCache:{hint:`${t}`,inputDependencies:u},getRunData:()=>({outputs:[{dims:i,dataType:r}],dispatchGroup:{x:Math.ceil(a/64)},programUniforms:d}),getShaderSource:f}},js=(e,t)=>{let i=e.inputs,r=i[0].dims,a=k.normalizeAxis(t.axis,r.length);Gs(i,a);let s=r.slice();s[a]=i.reduce((o,u)=>o+(u.dims.length>a?u.dims[a]:0),0);let n=i.filter(o=>k.size(o.dims)>0);e.compute(Fs(n,a,s,i[0].dataType),{inputs:n})},Ks=e=>Z({axis:e.axis})}),Ve,Le,Ge,Di,We=z(()=>{P(),q(),Ve=(e,t,i="f32")=>{switch(e.activation){case"Relu":return`value = max(value, ${t}(0.0));`;case"Sigmoid":return`value = (${t}(1.0) / (${t}(1.0) + exp(-value)));`;case"Clip":return`value = clamp(value, ${t}(${i}(uniforms.clip_min)), ${t}(${i}(uniforms.clip_max)));`;case"HardSigmoid":return`value = max(${t}(0.0), min(${t}(1.0), ${i}(uniforms.alpha) * value + ${i}(uniforms.beta)));`;case"LeakyRelu":return`value = select(${i}(uniforms.alpha) * value, value, value >= ${t}(0.0));`;case"Tanh":return`let e2x = exp(-2.0 * abs(value));
              value = sign(value) * (1.0 - e2x) / (1.0 + e2x);
        `;case"":return"";default:throw new Error(`Unsupported activation ${e.activation}`)}},Le=(e,t)=>{e.activation==="Clip"?t.push({type:1,data:e.clipMax},{type:1,data:e.clipMin}):e.activation==="HardSigmoid"?t.push({type:1,data:e.alpha},{type:1,data:e.beta}):e.activation==="LeakyRelu"&&t.push({type:1,data:e.alpha})},Ge=(e,t)=>{e.activation==="Clip"?t.push({name:"clip_max",type:"f32"},{name:"clip_min",type:"f32"}):e.activation==="HardSigmoid"?t.push({name:"alpha",type:"f32"},{name:"beta",type:"f32"}):e.activation==="LeakyRelu"&&t.push({name:"alpha",type:"f32"})},Di=e=>{let t=(e==null?void 0:e.activation)||"";if(t==="HardSigmoid"){let[i,r]=(e==null?void 0:e.activation_params)||[.2,.5];return{activation:t,alpha:i,beta:r}}else if(t==="Clip"){let[i,r]=(e==null?void 0:e.activation_params)||[za,Ea];return{activation:t,clipMax:r,clipMin:i}}else if(t==="LeakyRelu"){let[i]=(e==null?void 0:e.activation_params)||[.01];return{activation:t,alpha:i}}return{activation:t}}}),ne,Qs,Mi=z(()=>{ne=(e,t)=>{switch(e){case 1:return t;case 2:return`vec2<${t}>`;case 3:return`vec3<${t}>`;case 4:return`vec4<${t}>`;default:throw new Error(`${e}-component is not supported.`)}},Qs=e=>`
...
`}),ft,Ui,Pi=z(()=>{P(),q(),L(),We(),ft=(e,t,i,r,a)=>{let s=r-i;return`
...
`},Ui=(e,t,i,r,a=!1,s)=>{let n=e[0].dims,o=e[1].dims,u=n[n.length-2],l=o[o.length-1],d=n[n.length-1],p=ee(l),h=ee(d),c=ee(u),f=k.size(i)/p/c,m=e.length>2,y=r?r.slice(0,-2):i.slice(0,-2),_=[k.size(y),u,l],g=[{type:12,data:f},{type:12,data:u},{type:12,data:l},{type:12,data:d}];Le(t,g),g.push(...D(y,n,o)),m&&g.push(...D(e[2].dims)),g.push(...D(_));let w=$=>{let b=ki("batch_dims",e[0].dataType,y.length),v=S("a",e[0].dataType,n.length,h),x=S("b",e[1].dataType,o.length,p),I=B("output",e[0].dataType,_.length,p),E=ae(I.type.tensor),A=Ve(t,I.type.value,E),N=[v,x],G="";if(m){let W=a?p:1;N.push(S("bias",e[2].dataType,e[2].dims.length,W)),G=`${a?`value += bias[col / ${W}];`:`value += ${I.type.value}(bias[row + i]);`}`}let U=[{name:"output_size",type:"u32"},{name:"M",type:"u32"},{name:"N",type:"u32"},{name:"K",type:"u32"}];Ge(t,U);let V=()=>{let W=`var a_data: ${v.type.value};`;for(let O=0;O<h;O++)W+=`
...
`}return W};return`
  ...
  `};return{name:"MatMulNaive",shaderCache:{hint:`${t.activation};${p};${h};${c};${a}`,inputDependencies:m?["rank","rank","rank"]:["rank","rank"]},getRunData:()=>({outputs:[{dims:s?s(i):i,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(f/64)},programUniforms:g}),getShaderSource:w}}}),Xs,Ys,Ni,qi,Js,Vi,eo,Ut,Li=z(()=>{P(),q(),L(),We(),Pi(),Mi(),Xs=(e,t)=>e?`
...
`},eo=(e,t,i,r,a=!1)=>{let[s,n,o,u]=r,l=ae(r[0].type.tensor);return`
  ...
  ${m?Ni(y,_,O,W):Vi(y,_,O,W)}
    ...
    return ${ne(o,l)}(0.0);`,b=ne(u,l),v=ne(e?n:o,l),x=ne(e?o:n,l),I=Ve(s,b,l);return`
    ...
    fn mm_write(batch: i32, row : i32, colIn : i32, valueIn : ${b}) {
      ...
      fn setOutputAtCoords(d0 : i32, d1 : i32, d2 : i32, d3 : i32, value : ${m?`vec4<${M}>`:M}) {
        ...
        fn getBiasByOutputCoords(coords : array<u32, 5>) -> ${w} {
          ...
          }`};return{name:"Conv3DNaive",shaderCache:{hint:`${t.cacheKey};${n};${d};${f}`,inputDependencies:c},getRunData:()=>({outputs:[{dims:i,dataType:e[0].dataType}],dispatchGroup:{x:l[0],y:l[1],z:l[2]},programUniforms:h}),getShaderSource:m}}}),uo,lo,xp=z(()=>{P(),q(),L(),We(),uo=(e,t,i,r)=>{let a=e.length>2,s=a?"value += b[output_channel];":"",n=e[0].dims,o=e[1].dims,u=t.format==="NHWC",l=u?i[3]:i[1],d=l/t.group,p=u&&d>=4?ee(l):1,h=k.size(i)/p,c=[{type:12,data:h},{type:12,data:t.dilations},{type:12,data:[t.strides[0],t.strides[1]]},{type:12,data:[t.pads[0],t.pads[1]]},{type:12,data:d}];Le(t,c),c.push(...D(n,[o[0],o[1],o[2],o[3]/p]));let f=a?["rank","rank","rank"]:["rank","rank"];c.push(...D([i[0],i[1],i[2],i[3]/p]));let m=y=>{let _=B("output",e[0].dataType,i.length,p),g=ae(_.type.tensor),w=Ve(t,_.type.value,g),$=S("x",e[0].dataType,n.length),b=S("w",e[1].dataType,o.length,p),v=[$,b];a&&v.push(S("b",e[2].dataType,e[2].dims,p));let x=[{name:"output_size",type:"u32"},{name:"dilations",type:"u32",length:t.dilations.length},{name:"strides",type:"u32",length:2},{name:"pads",type:"u32",length:2},{name:"output_channels_per_group",type:"u32"}];Ge(t,x);let I=u?`
  ...
  }`};return{name:"GroupedConv",shaderCache:{hint:`${t.cacheKey}_${p}`,inputDependencies:f},getRunData:()=>({outputs:[{dims:r?r(i):i,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(h/64)},programUniforms:c}),getShaderSource:m}},lo=(e,t,i,r)=>{let a=e.length>2,s=ee(i[3]),n=ee(i[2]),o=k.size(i)/s/n,u=[e[0].dims[0],e[0].dims[1],e[0].dims[2],e[0].dims[3]/s],l=[e[1].dims[0],e[1].dims[1],e[1].dims[2],e[1].dims[3]/s],d=[i[0],i[1],i[2],i[3]/s],p=[{type:12,data:o},{type:6,data:[t.strides[0],t.strides[1]]},{type:6,data:[t.pads[0],t.pads[1]]}];Le(t,p),p.push(...D(u,l,d));let h=(n-1)*t.strides[1]+l[1],c=f=>{let m=B("output",e[0].dataType,d.length,s),y=ae(m.type.tensor),_=Ve(t,m.type.value,y),g=S("x",e[0].dataType,u.length,s),w=S("w",e[1].dataType,l.length,s),$=[g,w];a&&$.push(S("b",e[2].dataType,e[2].dims,s));let b=a?"value += b[output_channel];":"",v=[{name:"output_size",type:"u32"},{name:"strides",type:"i32",length:2},{name:"pads",type:"i32",length:2}];return Ge(t,v),`
...
`)};
    ...
    }`};return{name:"FastGeluWithBias",shaderCache:{hint:`${a}`,inputDependencies:["type","type"]},getShaderSource:s,getRunData:n=>({outputs:[{dims:n[0].dims,dataType:n[0].dataType}],programUniforms:[{type:12,data:Math.ceil(i/4)},{type:12,data:r}],dispatchGroup:{x:Math.ceil(i/Je/4)}})}},Go=e=>{e.inputs.length<2||k.size(e.inputs[1].dims)===0?vs(e):e.compute(Lo(e.inputs))}}),Wo,Ho,Fo,jo,Ap=z(()=>{P(),q(),te(),L(),Wo=e=>{if(!e||e.length!==2)throw new Error("Gather requires 2 inputs.")},Ho=(e,t)=>{let i=e[0].dims,r=e[1].dims,a=i.length,s=k.normalizeAxis(t.axis,a),n=i.slice(0);n.splice(s,1,...r);let o=i[s],u=e[0].dataType===9?4:1,l=Math.ceil(k.size(n)/u),d=[{type:12,data:l},{type:6,data:o},{type:12,data:s},...D(e[0].dims,e[1].dims,n)],p=h=>{let c=S("data",e[0].dataType,e[0].dims.length,u),f=S("inputIndices",e[1].dataType,e[1].dims.length),m=B("output",e[0].dataType,n.length,u),y=g=>{let w=r.length,$=`var indicesIndices${g}  = ${f.type.indices}(0);`;for(let b=0;b<w;b++)$+=`${w>1?`indicesIndices${g}[${b}]`:`indicesIndices${g}`} = ${n.length>1?`outputIndices${g}[uniforms.axis + ${b}]`:`outputIndices${g}`};`;$+=`
...
`,fu=(e,t,i)=>`
  fn pixel_at_grid(r: i32, c: i32, H: i32, W: i32, batch: u32, channel: u32, border: vec4<f32>) -> ${t} {
     ...
     indices[${Ee}] = channel;`+(()=>{switch(i.paddingMode){case"zeros":return`
        ...
        `;case"border":return`
          indices[${He}] = u32(clamp(r, 0, H - 1));
          indices[${Fe}] = u32(clamp(c, 0, W - 1));
        `;case"reflection":return`
          indices[${He}] = gs_reflect(r, border[1], border[3]);
          indices[${Fe}] = gs_reflect(c, border[0], border[2]);
...
`,mu=(e,t,i)=>(()=>{switch(i.mode){case"nearest":return`
  ...
  ${p.mainStart()}
    ${p.guardAgainstOutOfBoundsWorkgroupSizes("uniforms.output_size")}
      let H_in = i32(uniforms.x_shape[${He}]);
      let W_in = i32(uniforms.x_shape[${Fe}]);
      ...
      var grid_indices = vec3<u32>(indices[${Ie}], indices[${He}], indices[${Fe}]);
 ...
 * limitations under the License.
 * =============================================================================
 */rt.exports=at})(Gd);var Fd=Gd.exports;const gh=ch(Fd),yh=mh({__proto__:null,default:gh},[Fd]);export{yh as o};
