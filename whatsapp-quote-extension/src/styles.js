export const styles = `
  ...
  * {
  ...
  .mf-available-products header,
  .mf-available-products article {
    display: flex;
    align-items: center;
    justify-content: space-between;
    gap: 10px;
  ...
  .mf-available-products header strong {
    color: #6b4f00;
    font-size: 12px;
    text-transform: uppercase;
  }
  ...
  .mf-available-products span {
    display: grid;
    min-width: 0;
  }

  .mf-available-products b,
  .mf-available-products small {
    overflow: hidden;
    text-overflow: ellipsis;
    white-space: nowrap;
  }
  ...
  .mf-available-products div {
    display: flex;
    flex: 0 0 auto;
    gap: 5px;
  }

  .mf-available-products button {
    height: 28px;
    padding: 0 8px;
  ...
  .mf-oos-client input,
  .mf-oos-products input,
  .mf-oos-line input[type="text"],
  .mf-oos-line > input,
  .mf-oos-body textarea {
    width: 100%;
    min-width: 0;
    border: 1px solid #cfdcd6;
    border-radius: 6px;
  ...
  .mf-oos-search-icon:hover {
    border-color: #128c7e;
    background: #e8f5ee;
  }

  .mf-oos-product-window {
    position: absolute;
    inset: 0;
    z-index: 1;
    display: grid;
